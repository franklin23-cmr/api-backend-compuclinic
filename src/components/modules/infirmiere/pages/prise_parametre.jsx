...
import { submitParameters } from '../network/infimiere.network';

export const PriseParametre = ({ location }) => {
          ...
          <Space size={50} style={{ width: '100%' }}>
            ...
            >
              <Select style={{ width: '100%' }} placeholder='type de parametre'>
                ...
                <Select.Option value='Température'>
                  Température °C
                </Select.Option>
                <Select.Option value='Pression'>Préssion</Select.Option>
              </Select>
            </Form.Item>
          ...
          onClick={async () => {
            ...
            submitParameters(parameters).then((data) => {
              if (data.result) {
                ...
                history.push('/infirmiere/patient-attente');
              } else {
                notification.error({
                  message: 'Erreur',
                  description: "Les paramètres n'ont pas été enregistrés",
                });
              }
            });
          }}
