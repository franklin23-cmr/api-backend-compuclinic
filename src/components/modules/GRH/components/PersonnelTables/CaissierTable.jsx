...
import { getCaissiere } from '../../network/grh.network';

export const CaissierTable = () => {
  ...
  const actionFormatter = (cell, row) => {
    return (
      <Space>
        <Tooltip title='détails du caissier'>
          <ButtonWithModal
        ...
        <Tooltip title='modifier le caissier'>
          <ButtonWithModal
            buttonText={<FaPen size={18} />}
            buttonProps={{ type: 'primary' }}
            modalProps={{
              title: (
                <span style={{ color: 'white' }}>
                  Modifier les informations du sécretaire
                </span>
              ),
              width: 650,
            }}
              ...
              >
                ...
                <div>
                  <h5 style={{ textAlign: 'center' }}>
                    Voulez vous modifier les informations du caissier
                  </h5>
                  <p
                    style={{
                      fontWeight: 'bold',
  ...
  return <Table isLoading={isLoading} data={caissiers} columns={columns} />;
};
