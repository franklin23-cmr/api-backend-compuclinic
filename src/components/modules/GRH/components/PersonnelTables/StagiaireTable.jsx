...
import { getStagiaire } from '../../network/grh.network';

export const StagiaireTable = () => {
  ...
  const actionFormatter = (cell, row) => {
    return (
      <Space>
        <Tooltip title='détails du Stagiaire'>
          <ButtonWithModal
        ...
        <Tooltip title='modifier stagiaire'>
          <ButtonWithModal
            buttonText={<FaPen size={13} color='white' />}
            modalProps={{
              title: (
                <span style={{ color: 'white' }}>Modifier le stagiaire</span>
              ),
              width: 650,
            }}
            buttonProps={{ style: { backgroundColor: '#ff8619' } }}
              ...
              >
                ...
                <div>
                  <h5 style={{ textAlign: 'center' }}>
                    Voulez vous modifier les informations du stagiaire
                  </h5>
                  <p
                    style={{
                      fontWeight: 'bold',
                  ...
                  >
                    <Link
                      to={{
                        ...
                        state: { stagiaire: row, tabIndex: '6' },
                      }}
                      onClick={() => closeModal()}
                    >
  ...
  const columns = [
    ...
    {
      dataField: 'stage.date_debut',
      text: 'Date début stage',
      sort: true,
      formatter: dateFormatterNoTime,
    },
    {
      dataField: 'stage.date_fin',
      text: 'Date fin stage',
      sort: true,
      formatter: dateFormatterNoTime,
    },
  ...
  return <Table isLoading={isLoading} data={stagiaire} columns={columns} />;
};
