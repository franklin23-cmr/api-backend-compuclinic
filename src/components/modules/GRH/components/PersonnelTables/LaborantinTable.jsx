...
import { getLaborantin } from '../../network/grh.network';

export const LaborantinTable = () => {
  ...
  const actionFormatter = (cell, row) => {
    return (
      <Space>
        <Tooltip title='détails du Laborantin'>
          <ButtonWithModal
        ...
        <Tooltip title='modifier Laborantin'>
          <ButtonWithModal
            buttonText={<FaPen size={13} color='white' />}
            modalProps={{
              title: (
                <span style={{ color: 'white' }}>Modifier le Laborantin</span>
              ),
              width: 650,
            }}
            buttonProps={{ style: { backgroundColor: '#ff8619' } }}
              ...
              >
                ...
                <div>
                  <h5 style={{ textAlign: 'center' }}>
                    Voulez vous modifier les informations du Laborantin
                  </h5>
                  <p
                    style={{
                      fontWeight: 'bold',
                  ...
                  >
                    <Link
                      to={{
                        ...
                        state: { laborantin: row, tabIndex: '5' },
                      }}
                      onClick={() => closeModal()}
                    >
            ...
            modalProps={{
              title: (
                <span style={{ color: 'white' }}>
                  Emploie du temps de Laborantin
                </span>
              ),
              width: 1000,
            }}
  ...
  return <Table isLoading={isLoading} data={laborantins} columns={columns} />;
};
